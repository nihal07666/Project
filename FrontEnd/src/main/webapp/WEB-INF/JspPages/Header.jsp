...
<div class="navbar-header">
				<a href="" class="navbar-brand"><%-- <img alt="" src="<c:url value="/Resources/images/img1.jpg"   />"></img> --%></a>&nbsp;&nbsp;&nbsp;
...
<li class="dropdown"><a href="#" class="dropdown-toggle"
				...
				<li><a href="#">Seadans</a><li>
				<li><a href="#">Suv</a></li>
				</ul>
</li>
<li><a href="login"><span class="glyph glyphicon-user"></span>Sign Out</a></li>		
